...
CLI_SRCS := src/cli_args.cpp src/cli_parse.cpp src/cli_help.cpp src/cli_shared.cpp src/cli_project_cmds.cpp src/cli_ops_draw.cpp src/cli_ops.cpp src/cli_impl.cpp
